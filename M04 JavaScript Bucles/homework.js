...
function fizzBuzz(num) {
   ...
   // De lo contrario, retorna false.
   // Tu código:
   if(num%3===0 && num%5!=0){return "fizz";} else if(num%5===0 && num%3!=0){return "buzz";}
   else if(num%3===0 && num%5===0){return "fizzbuzz";} else{return false;}
}
...
function tieneTresDigitos(num) {
   ...
   // Tu código:
   if(num>=100 && num<=999){return true;} else{return false;}
}
