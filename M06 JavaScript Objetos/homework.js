...
function crearGato(nombre, edad) {
   ...
   var cat={nombre:nombre,edad:edad,meow:()=>{return "Meow!";}}
   return cat;
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var numMisPor5=objetoMisterioso.numeroMisterioso*5;
   return numMisPor5;
}
...
function agregarMetodoCalculoDescuento(objetoProducto) {
   ...
   function() {prod=this.precio*this.porcentajeDeDescuento; dif=this.precio-prod;
   return dif;};
