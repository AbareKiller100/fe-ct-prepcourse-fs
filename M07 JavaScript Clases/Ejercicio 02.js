...
class Persona {
   ...
   // sus valores.
      constructor(nombre,apellido,edad,domicilio){
       ...
       detalle(){ var pers={nombre:this.nombre,apellido:this.apellido,edad:this.edad,domicilio:this.domicilio};
       return pers;
       }
}
...
function crearInstanciaPersona(nombre, apellido, edad, domicilio) {
   ...
   // Tu código:
   var Maximo=new Persona(nombre,apellido,edad,domicilio)
   return Maximo;
